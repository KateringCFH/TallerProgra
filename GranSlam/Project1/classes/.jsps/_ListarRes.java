  /*@lineinfo:filename=/ListarRes.jsp*/
...
public class _ListarRes extends oracle.jsp.runtime.HttpJsp {
    ...
    */
    ...
    try {
      ...
      /*@lineinfo:translated-code*//*@lineinfo:16^1*/      {
        ...
        __jsp_taghandler_1.setAction("/listares");
        ...
        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
        {
          do {
            ...
            /*@lineinfo:translated-code*//*@lineinfo:25^1*/            {
              ...
              __jsp_taghandler_2.setName("lista_res");
              ...
              if (OracleJspRuntime.checkStartBodyTagEval(__jsp_tag_starteval))
              {
                ...
                do {
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:28^9*/                  {
                    ...
                    __jsp_taghandler_3.setProperty("cod_set");
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:29^9*/                  {
                    ...
                    __jsp_taghandler_4.setProperty("cod_part");
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:30^9*/                  {
                    ...
                    __jsp_taghandler_5.setProperty("codeq1");
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:31^9*/                  {
                    ...
                    __jsp_taghandler_6.setProperty("codeq2");
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:32^9*/                  {
                    ...
                    __jsp_taghandler_7.setProperty("res_total");
                ...
                /*@lineinfo:translated-code*//*@lineinfo:32^57*/                } while (__jsp_taghandler_2.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
