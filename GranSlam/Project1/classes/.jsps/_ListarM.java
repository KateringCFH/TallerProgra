...
public class _ListarM extends oracle.jsp.runtime.HttpJsp {
    ...
    */
    ...
    try {
      ...
      /*@lineinfo:translated-code*//*@lineinfo:22^3*/      {
        ...
        __jsp_taghandler_1.setName("listado_modalidad");
        ...
        if (OracleJspRuntime.checkStartBodyTagEval(__jsp_tag_starteval))
        {
          ...
          /*@lineinfo:translated-code*//*@lineinfo:25^58*/          } while (__jsp_taghandler_1.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
