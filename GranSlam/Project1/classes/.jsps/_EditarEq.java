  /*@lineinfo:filename=/EditarEq.jsp*/
...
public class _EditarEq extends oracle.jsp.runtime.HttpJsp {
    ...
    */
    ...
    try {
      ...
      /*@lineinfo:translated-code*//*@lineinfo:27^1*/      {
        ...
        __jsp_taghandler_1.setAction("/editareq");
        ...
        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
        {
          do {
            ...
            /*@lineinfo:translated-code*//*@lineinfo:34^1*/            {
              ...
              __jsp_taghandler_2.setName("muestraeq");
              ...
              if (OracleJspRuntime.checkStartBodyTagEval(__jsp_tag_starteval))
              {
                ...
                do {
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:37^11*/                  {
                    ...
                    if (OracleJspRuntime.checkStartBodyTagEval(__jsp_tag_starteval))
                    {
                      ...
                      /*@lineinfo:translated-code*//*@lineinfo:38^60*/                      } while (__jsp_taghandler_3.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
                ...
                /*@lineinfo:translated-code*//*@lineinfo:40^61*/                } while (__jsp_taghandler_2.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
                out=OracleJspRuntime.popBodyIfNeeded(pageContext,out);
              }
          ...
          /*@lineinfo:translated-code*//*@lineinfo:44^17*/          } while (__jsp_taghandler_1.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
        }
