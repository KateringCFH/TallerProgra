...
public class _BajasJ extends oracle.jsp.runtime.HttpJsp {
    ...
    */
    ...
    try {
      ...
      /*@lineinfo:translated-code*//*@lineinfo:16^1*/      {
        ...
        __jsp_taghandler_1.setAction("/bajas_jugador");
        ...
        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
        {
          do {
            ...
            /*@lineinfo:translated-code*//*@lineinfo:27^1*/            {
              ...
              __jsp_taghandler_2.setName("bajas_jugador");
              ...
              if (OracleJspRuntime.checkStartBodyTagEval(__jsp_tag_starteval))
              {
                ...
                do {
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:30^17*/                  {
                    ...
                    if (OracleJspRuntime.checkStartBodyTagEval(__jsp_tag_starteval))
                    {
                      ...
                      do {
                        ...
                        /*@lineinfo:translated-code*//*@lineinfo:31^17*/                        {
                          ...
                          __jsp_taghandler_4.setProperty("codigoj");
                      ...
                      /*@lineinfo:translated-code*//*@lineinfo:31^63*/                      } while (__jsp_taghandler_3.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:34^17*/                  {
                    ...
                    __jsp_taghandler_5.setProperty("codigoeq");
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:35^17*/                  {
                    ...
                    __jsp_taghandler_6.setProperty("codigoe");
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:36^17*/                  {
                    ...
                    __jsp_taghandler_7.setProperty("nomj");
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:37^17*/                  {
                    ...
                    __jsp_taghandler_8.setProperty("apj");
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:38^17*/                  {
                    ...
                    __jsp_taghandler_9.setProperty("genj");
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:39^17*/                  {
                    ...
                    __jsp_taghandler_10.setProperty("ganaj");
                ...
                /*@lineinfo:translated-code*//*@lineinfo:39^61*/                } while (__jsp_taghandler_2.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
                out=OracleJspRuntime.popBodyIfNeeded(pageContext,out);
              }
          ...
          /*@lineinfo:translated-code*//*@lineinfo:41^17*/          } while (__jsp_taghandler_1.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
        }
