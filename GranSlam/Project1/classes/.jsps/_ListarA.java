    ...
    */
    ...
    try {
      ...
      /*@lineinfo:translated-code*//*@lineinfo:17^1*/      {
        ...
        __jsp_taghandler_1.setAction("/listarA");
        ...
        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
        {
          do {
            ...
            /*@lineinfo:translated-code*//*@lineinfo:24^1*/            {
              ...
              __jsp_taghandler_2.setName("muestraA");
              ...
              if (OracleJspRuntime.checkStartBodyTagEval(__jsp_tag_starteval))
              {
                ...
                do {
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:26^9*/                  {
                    ...
                    __jsp_taghandler_3.setProperty("cod_a");
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:27^9*/                  {
                    ...
                    __jsp_taghandler_4.setProperty("nombre_a");
                ...
                /*@lineinfo:translated-code*//*@lineinfo:28^58*/                } while (__jsp_taghandler_2.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
          ...
          /*@lineinfo:translated-code*//*@lineinfo:30^17*/          } while (__jsp_taghandler_1.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
        }
