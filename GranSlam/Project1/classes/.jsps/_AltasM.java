...
public class _AltasM extends oracle.jsp.runtime.HttpJsp {
    ...
    */
    ...
    try {
      ...
      /*@lineinfo:translated-code*//*@lineinfo:17^1*/      {
        ...
        __jsp_taghandler_1.setAction("/altam");
        ...
        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
        {
          do {
            ...
            /*@lineinfo:translated-code*//*@lineinfo:21^11*/            {
              ...
              __jsp_taghandler_2.setKey("altam.codigo");
            ...
            /*@lineinfo:translated-code*//*@lineinfo:25^11*/            {
              ...
              __jsp_taghandler_4.setKey("altam.nombre");
            ...
            /*@lineinfo:translated-code*//*@lineinfo:29^38*/            {
          ...
          /*@lineinfo:translated-code*//*@lineinfo:29^71*/          } while (__jsp_taghandler_1.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
        }
