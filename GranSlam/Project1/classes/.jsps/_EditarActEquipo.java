  /*@lineinfo:filename=/EditarActEquipo.jsp*/
...
public class _EditarActEquipo extends oracle.jsp.runtime.HttpJsp {
    ...
    */
    ...
    try {
      ...
      /*@lineinfo:translated-code*//*@lineinfo:17^1*/      {
        ...
        __jsp_taghandler_1.setAction("/edit_equipo");
        ...
        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
        {
          do {
            ...
            /*@lineinfo:translated-code*//*@lineinfo:19^1*/            {
              ...
              __jsp_taghandler_2.setName("editar_eq");
              ...
              if (OracleJspRuntime.checkStartBodyTagEval(__jsp_tag_starteval))
              {
                ...
                do {
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:21^7*/                  {
                    ...
                    __jsp_taghandler_3.setKey("alteq.cod");
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:25^9*/                  {
                    ...
                    __jsp_taghandler_5.setKey("alteq.nombreq");
                  ...
                  /*@lineinfo:translated-code*//*@lineinfo:26^9*/                  {
                    ...
                    __jsp_taghandler_6.setProperty("modalidad");
                ...
                /*@lineinfo:translated-code*//*@lineinfo:26^55*/                } while (__jsp_taghandler_2.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
                out=OracleJspRuntime.popBodyIfNeeded(pageContext,out);
              }
            ...
            /*@lineinfo:translated-code*//*@lineinfo:33^9*/            {
              ...
              __jsp_taghandler_7.setValue("Guardar");
          ...
          /*@lineinfo:translated-code*//*@lineinfo:33^40*/          } while (__jsp_taghandler_1.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
        }
