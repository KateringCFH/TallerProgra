  /*@lineinfo:filename=/ModEntrenador.jsp*/
...
public class _ModEntrenador extends oracle.jsp.runtime.HttpJsp {
    ...
    */
    ...
    try {
      ...
      /*@lineinfo:translated-code*//*@lineinfo:16^1*/      {
        ...
        __jsp_taghandler_1.setAction("/mod_entrenador");
        ...
        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
        {
          do {
            ...
            /*@lineinfo:translated-code*//*@lineinfo:23^1*/            {
              ...
              __jsp_taghandler_2.setName("mod_entrenador");
